...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, ar.edu.um.fi.programacion2.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, ar.edu.um.fi.programacion2.repository.UserRepository.USERS_BY_EMAIL_CACHE);
            createCache(cm, ar.edu.um.fi.programacion2.domain.User.class.getName());
